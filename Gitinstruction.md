...
2. Чтобы создать удаленный репозиторий, используйте команду git push.
3. Если это делается впервые, то Git потребуется авторизация на GitHub.
4. Вы можете отправлять изменения, только если вы имеете право отправлять их на этот репозиторий.
